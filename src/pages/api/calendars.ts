...
export default function handler(
  ...
  res.status(200).json({ 
		calendars: [
			...
			{
				name: 'F1 Academy',
				endpointURL: 'https://f1academycalendar.com/api/year/2024',
			...
			{
				name: 'Formula 2',
				endpointURL: 'https://f2cal.com/api/year/2024',
			...
			{
				name: 'Formula E',
				endpointURL: 'https://formulaecal.com/api/year/2024',
				calendarURL: 'webcal://files-fe.motorsportcalendars.com/fe-calendar_p1_p2_p3_qualifying_race.ics',
			},
			{
				name: 'Extreme E',
				endpointURL: 'https://extremeecalendar.com/api/year/2024',
			...
			{
				name: 'MotoGP',
				endpointURL: 'https://motogpcal.com/api/year/2024',
